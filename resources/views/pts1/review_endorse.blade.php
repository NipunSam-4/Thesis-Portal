            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $student->date_confirmation ? \Carbon\Carbon::parse($student->date_confirmation)->format('d-m-Y') : 'N/A' }}" readonly class="w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 font-bold rounded-lg border-gray-300 dark:border-gray-600 cursor-not-allowed">
                    </div>
                </div>
            </div>
            ...
            @if($showActionForm)
                ...
                <form action="{{ route('pts1.endorse', $pts1->id) }}" method="POST" class="space-y-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-indigo-100 dark:border-indigo-900/50 p-6 space-y-6">
                        ...
                        <!-- Item 3: Dynamic Recommendation / Verification Remark -->
                        <div class="space-y-2 pt-2">
                            <label class="block font-bold text-gray-900 dark:text-white text-sm">
                                @if($pts1->current_stage === 'section_officer')
