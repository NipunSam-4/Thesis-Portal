                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="seminar_date" required value="{{ old('seminar_date') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                        </div>
                            ...
                            <div x-show="pubApproval === '1'" class="pt-2">
                                ...
                                <div x-show="fileStates.pubApp.name" x-cloak class="p-3 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-xl flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2 shrink-0">
                                        ...
                                        <button type="button" @click="clearFile('pubApp', 'pubAppInput')" class="px-2.5 py-1 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg text-xs font-bold shadow-sm hover:bg-gray-100 flex items-center">
                                            ✏ Change File
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div x-show="timeApproval === '1'" class="pt-2">
                                ...
                                <div x-show="fileStates.timeApp.name" x-cloak class="p-3 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-xl flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2 shrink-0">
                                        ...
                                        <button type="button" @click="clearFile('timeApp', 'timeAppInput')" class="px-2.5 py-1 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg text-xs font-bold shadow-sm hover:bg-gray-100 flex items-center">
                                            ✏ Change File
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div x-show="fileStates.synopsis.name" x-cloak class="p-3 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-xl flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2 shrink-0">
                                    ...
                                    <button type="button" @click="clearFile('synopsis', 'synopsisInput')" class="px-2.5 py-1 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg text-xs font-bold shadow-sm hover:bg-gray-100 flex items-center">
                                        ✏ Change File
                                    </button>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div x-show="fileStates.pubList.name" x-cloak class="p-3 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-xl flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2 shrink-0">
                                    ...
                                    <button type="button" @click="clearFile('pubList', 'pubListInput')" class="px-2.5 py-1 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg text-xs font-bold shadow-sm hover:bg-gray-100 flex items-center">
                                        ✏ Change File
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        function pts1Form() {
            return {
                ...
                // Standard default PHP php.ini upload limit (2 MB = 2048 KB)
                maxSizes: {
                    synopsis: 2, // 2 MB limit
