    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 space-y-4">
            ...
            @php
                ...
                $hasAnyComment = ($pts4->main_supervisor_submitted_at || $pts4->main_supervisor_recommendation !== null || !is_null($pts4->main_supervisor_student_comment))
                    || $hasAnyCo
                    || (!$isStudent && ($pts4->academic_office_submitted_at || $pts4->academic_office_is_verified !== null || !is_null($pts4->academic_office_verification_remark)))
                    || ($pts4->dr_submitted_at || $pts4->dr_approval !== null || !is_null($pts4->dr_student_comment));
            @endphp
