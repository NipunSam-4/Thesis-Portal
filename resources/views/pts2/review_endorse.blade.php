        ...
        <div class="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label class="flex items-center text-xs font-semibold uppercase text-gray-500 mb-1">
                            <span>Course Credits Required (From System)</span>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 space-y-2">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $pts2->effective_thesis_title }}" readonly class="w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg border-gray-300 dark:border-gray-600 cursor-not-allowed">
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 space-y-6">
                ...
                <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600 space-y-2">
                    <div class="text-xs font-bold text-gray-500 uppercase flex items-center gap-2">
                        <span>Final PhD Synopsis Report</span>
                    ...
                    @if($pts2->getEffectiveSynopsisPath())
                        <a href="{{ route('pts.document.serve', ['pts2', $pts2->id, $pts2->getEffectiveSynopsisField()]) }}" target="_blank" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-lg shadow transition inline-flex items-center">
                            📄 View Document
                        </a>
                    @else
