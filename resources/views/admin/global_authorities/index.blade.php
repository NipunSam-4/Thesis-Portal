        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800/50">
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">Institute Global Authorities</h3>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Total Assigned: {{ $authorities->count() }}</span>
                    </div>
                    
                    <button @click="createModalOpen = true" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-lg shadow-sm transition transform hover:-translate-y-0.5 flex items-center text-sm">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-900/50 text-gray-500 text-xs uppercase tracking-wider border-b border-gray-200">
                                <th class="p-4 font-medium">Authority Name</th>
                                <th class="p-4 font-medium">Institute Role</th>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    ...
                                    <td class="p-4 flex justify-end space-x-3">
                                        ...
                                        <form action="{{ route('system_admin.users.toggle', $user->id) }}" method="POST">
                                            ...
                                            @method('PATCH')
                                            @if($user->is_active)
                                                <button type="submit" onclick="return confirm('Deactivate this authority? They will lose all portal access.');" class="text-orange-600 hover:text-orange-900 font-medium px-3 py-1 rounded bg-orange-50 hover:bg-orange-100 transition w-24 text-center">
                                                    Deactivate
                                                </button>
                                            @else
        ...
        <div x-show="createModalOpen" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="createModalOpen" class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                    ...
                    <form action="{{ route('system_admin.global_authorities.store') }}" method="POST">
                        @csrf
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Assign Global Authority</h3>
                            ...
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Global Role</label>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="submit" class="w-full inline-flex justify-center rounded-md px-4 py-2 bg-orange-600 text-white hover:bg-orange-700 sm:ml-3 sm:w-auto text-sm font-medium">
                                Assign Role
                            </button>
